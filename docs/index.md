...
レビューの視点を明確化して行います。レビューとは何らかの問題に対する解決策が正しいかどうかを検証するだと考えています。つまりコードを読むことから始まるアクションだけではなく、まず問題自体の理解から始める必要があります。

以下のリストは[コードレビューで聞く質問集 \- rastam on rails](https://rastam.hatenablog.com/entry/questions-to-ask-in-code-reviews)を参考に、自分用に微修正・分類したものです。
...
- マージ前後にやることはありますか。
- デプロイ前後にやることはありますか。PR作者に確認しましたか。
