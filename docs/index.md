...
0. リモートワークを好みますが、組織の状況によっては対面を選択することがあります。 - 文書化、合意事項がない中でのリモートワークはコミュニケーションコストが大きく、働きにくいからです。全体的な合意事項として定められたことなしに、ひとりひとりの相手に方法、コミュニケーションについて指摘したり、強制したくありません．
